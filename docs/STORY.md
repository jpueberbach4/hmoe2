...
Note: removed the model advice since i had a leakage issue. I forgot to shift the weekly candles by 1. Back to drawing board. Still have near 50 percent WR but the entries are not optimal.
